...
$selection = '(id:chla* OR id:hive* OR id:hearth*) AND (has_model_ssim:"Issue" OR has_model_ssim:"Journal" OR has_model_ssim:"Article" OR id:*_1_fs OR has_model_ssim:"Book" OR has_model_ssim:"Series")';

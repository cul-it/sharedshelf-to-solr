...
class SharedShelfMetadataApplicationProfile {
    ...
    private $map_fields = array(
        ...
        "Identifier_Type" => array( 'map_name' => "Identifier_Type", 'solr_name' => "map_identifier_type", 'multivalued' => FALSE, 'type' => "string" ),
        ...
        "Measurement_Dimension" => array( 'map_name' => "Measurement_Dimension", 'solr_name' => "map_measurement_dimension", 'multivalued' => FALSE, 'type' => "string" ),
        "Measurement_Unit" => array( 'map_name' => "Measurement_Unit", 'solr_name' => "map_measurement_unit", 'multivalued' => FALSE, 'type' => "string" ),
        ...
        "Record Creation Date" => array( 'map_name' => "Record Creation Date", 'solr_name' => "map_record_creation_date", 'multivalued' => FALSE, 'type' => "date" ),
        "Record Creator" => array( 'map_name' => "Record Creator", 'solr_name' => "map_record_creator", 'multivalued' => TRUE, 'type' => "string" ),
        "Record Update Date" => array( 'map_name' => "Record Update Date", 'solr_name' => "map_record_update_date", 'multivalued' => TRUE, 'type' => "date" ),
        "Record Updator" => array( 'map_name' => "Record Updator", 'solr_name' => "map_record_updator", 'multivalued' => TRUE, 'type' => "string" ),
        ...
        "Title" => array( 'map_name' => "Title", 'solr_name' => "map_title", 'multivalued' => FALSE, 'type' => "string" ),
        "Title_Language" => array( 'map_name' => "Title_Language", 'solr_name' => "map_title_language", 'multivalued' => FALSE, 'type' => "string" ),
